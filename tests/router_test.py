...
test_serie = [
    {   'name'      : 'defaultroute1',
        ...
        'todos'     : [ {'function': wait_for_router_ready, 'args': []}, ##Let the normal route settle, then artificially trigger our test route
                        {'function': launch_router, 'args': ['']},
    ...
    {   'name'      : 'defaultroute3',
        ...
        'url'       : baseurl + '',
        'todos'     : [ {'function': wait_for_router_ready, 'args': []},
                        {'function': launch_router, 'args': ['expert']},
                        {'function': wait_for_router_ready, 'args': []} ],
    ...
    {   'name'      : 'params1',
        ...
        'todos'     : [ {'function': wait_for_router_ready, 'args': []},
                        {'function': launch_router, 'args': ['suckeleer']},
                        {'function': wait_for_router_ready, 'args': []} 
                      ],
    ...
    {   'name'      : 'params2',
        ...
        'url'       : baseurl + '/app1/user/123X',
        'todos'     : [ {'function': wait_for_router_ready, 'args': []},
                        {'function': launch_router, 'args': ['dikkenek']},
                        {'function': wait_for_router_ready, 'args': []},                          
                      ],
        'check'     : lambda browser: ('Called userDetails' in browser.find_element_by_css_selector('body').text) 
                                  and ( '"uid":"123X' in browser.find_element_by_css_selector('body').text)
    ...
    {   'name'      : 'params3',
        ...
        'url'       : baseurl + '/app1/user/123X',
        'todos'     : [ {'function': wait_for_router_ready, 'args': []},
                        {'function': launch_router, 'args': ['denbaas']},
                        {'function': wait_for_router_ready, 'args': []},                          
                      ],
        'check'     : lambda browser: ('Doh, this app does not serve this URL !' in browser.find_element_by_css_selector('body').text) 
    ...
    {   'name'      : 'role2',
        ...
        'url'       : baseurl + '/app2/proposals',
        'todos'     : [ {'function': wait_for_router_ready, 'args': []},
                        {'function': launch_router, 'args': ['paco']},
                        {'function': wait_for_router_ready, 'args': []} ],
    ...
    {   'name'      : 'makelink1',
        ...
        'url'       : baseurl + '/',
        'todos'     : [ {'function': wait_for_router_ready, 'args': []},
                        {'function': launch_router, 'args': ['toto']},
                        {'function': wait_for_router_ready, 'args': []},
                      ],
